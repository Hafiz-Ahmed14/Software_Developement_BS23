...
//             <h4 class="mb-0">${fullName.toUpperCase()}</h4>
//             <h4 class="mb-3">${desig.toUpperCase()}</h4>
//         </div>
...
//             <p class="mb-3">Linkedin: ${Linkedin}</p>
//         </div>
...
//         previewHTML += summary ? `<h5>Profile Summary</h5><p>${summary}</p>` : "";
//     }
...
//     if (visited_sections.includes("skills")) {
//         const skills = document.querySelectorAll("#skills-container .skill-entry input");
//         if (skills.length) {
//             previewHTML += `<h5>Skills</h5><ul>`;
...
//         const languages = document.querySelectorAll("#languages-container .language-entry");
//         if (languages.length) {
//             previewHTML += `<h5>Languages</h5><ul>`;
//             languages.forEach((entry) => {
//                 const name = entry.children[0].value;
//                 const reading = entry.children[1].value;
//                 const writing = entry.children[2].value;
//                 const speaking = entry.children[3].value;
//                 if (name || reading || writing || speaking) {
//                     previewHTML += `<li>${name}: Reading - ${reading}, Writing - ${writing}, Speaking - ${speaking}</li>`;
//                 }
//             });
//             previewHTML += `</ul>`;
//         }
...
//             previewHTML += `<h5>Work Experience</h5><ul>`;
...
//                     previewHTML += `<li><strong>${designation}</strong> at ${company}<br>${description}</li>`;
//                 }
//             });
//             previewHTML += `</ul>`;
//         }
...
//             previewHTML += `<h5>References</h5><ul>`;
